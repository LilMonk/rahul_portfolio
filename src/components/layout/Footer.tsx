        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-4">
            ...
            {contact.twitter && (
              ...
              >
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M7.5 5.25h9M7.5 9h9M7.5 12.75h9M4.5 19.5h15a2.25 2.25 0 002.25-2.25V6.75A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25v10.5A2.25 2.25 0 004.5 19.5z" />
                </svg>
              </a>
            )}
          </div>
