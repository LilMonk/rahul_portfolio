          ...
          <div className={`${colors.bgPrimary} p-8 rounded-lg shadow-md`}>
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                <div
                  className={`flex-shrink-0 h-12 w-12 flex items-center justify-center rounded-full ${colors.getThemeClass("bg-indigo-100 text-indigo-600", "bg-indigo-900 text-indigo-300")}`}
                >
                  <svg
                    className="h-6 w-6"
                    fill="none"
                ...
                <div className="ml-4">
                  ...
                  <p className={`mt-1 ${colors.textAccent}`}>
                    <a
                      ...
                      className={`hover:${colors.brandPrimary}`}
                    >
                      {contact.email}
                    </a>
                  </p>
