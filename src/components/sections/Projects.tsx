    ...
    <section id="projects" className={`py-16 ${colors.bgPrimary}`}>
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className={`text-3xl font-bold ${colors.textPrimary} mb-4`}>My Projects</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project) => (
            ...
            >
              <div className={`h-48 ${colors.getThemeClass('bg-gray-200', 'bg-gray-700')} relative`}>
                {project.imageUrl ? (
                  <img 
                  ...
                  <div className={`w-full h-full flex items-center justify-center ${colors.getThemeClass('bg-indigo-100', 'bg-indigo-900')}`}>
                    <span className={`text-xl font-semibold ${colors.getThemeClass('text-indigo-600', 'text-indigo-300')}`}>
              ...
              <div className="p-6">
                <h3 className={`font-bold text-xl ${colors.textPrimary} mb-2`}>{project.title}</h3>
                <p className={`${colors.textAccent} mb-4`}>{project.description}</p>
      ...
      {activeProject && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className={`${colors.bgPrimary} rounded-lg w-full max-w-3xl max-h-[90vh] overflow-y-auto`}>
            <div className="p-6">
              <div className="flex justify-between items-center mb-4">
                <h3 className={`text-2xl font-bold ${colors.textPrimary}`}>{activeProject.title}</h3>
                <button 
                  onClick={closeModal}
              ...
              <div className="mb-6">
                <h4 className={`text-lg font-semibold ${colors.textPrimary} mb-2`}>Technologies Used</h4>
