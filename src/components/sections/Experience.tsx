              ...
              {experiences.map((exp, index) => (
                ...
                >
                  <div className="flex flex-wrap justify-between mb-2">
                    ...
                    <span
                      className={`text-sm ${colors.textAccent} ${colors.getThemeClass("bg-gray-100", "bg-gray-600")} px-3 py-1 rounded-full`}
                    >
                  ...
                  <div className="flex items-center mb-4">
                    <span
                      className={`text-lg font-medium ${colors.brandPrimary}`}
                    >
                      {exp.company}
                    </span>
                  ...
                  <ul
                    className={`list-disc list-inside ${colors.textAccent} mb-4 space-y-2`}
                  >
            ...
            <div className="space-y-8">
              {education.map((edu, index) => (
                ...
                >
                  ...
                  {edu.description && (
                    <p className={colors.textAccent}>{edu.description}</p>
                  )}
                </div>
              ))}
            </div>
