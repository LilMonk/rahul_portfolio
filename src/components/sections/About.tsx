    ...
    <section id="about" className={`py-16 ${colors.bgSecondary}`}>
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className={`text-3xl font-bold ${colors.textPrimary} mb-4`}>About Me</h2>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <h3 className={`text-2xl font-bold ${colors.textPrimary} mb-4`}>{name}</h3>
            <h4 className={`text-xl ${colors.brandPrimary} mb-6`}>{title}</h4>
            
            <p className={`${colors.textAccent} mb-6 leading-relaxed`}>
              {bio}
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
              ...
              {contact.location && (
                <div className="flex items-center">
                  ...
                  <span className={colors.textSecondary}>{contact.location}</span>
                </div>
              )}
