...
export const projects: Project[] = [
  {
    ...
    description:
      "Developed a data pipeline to process and analyze IoT data streams, providing real-time insights and alerts.",
    imageUrl: logoImage, // Using logo image as fallback
    technologies: ["Apache Kafka", "Apache Spark", "BigQuery"],
    githubUrl:
      "https://medium.com/@lilmonk/a-journey-from-raw-data-to-actionable-insights-edb03a8f9c36",
    details:
      "Created a comprehensive data pipeline solution for processing and analyzing large volumes of IoT data. Implemented real-time data processing for immediate insights and alerts, enabling swift response to critical events.",
  },
  {
    id: "project-2",
    title: "Stream Processing For CDC Data",
    description:
      "Implemented a stream processing solution to handle Change Data Capture (CDC) events, ensuring real-time data synchronization across systems.",
    imageUrl: logoImage, // Using logo image as fallback
